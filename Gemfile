...
gem 'pulitzer', git: 'https://github.com/gkparishphilp/pulitzer.git', :tag => "v1.15.0", :branch => 'master'
...
gem 'dewey', git: 'https://github.com/MeisterMichael/dewey.git', :tag => "v1.2.1", :branch => 'master'
